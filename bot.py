...
def create_payment(update: Update, context: CallbackContext, user_id, amount, payment_type, details):
...
# Выбор комнаты
def handle_room_selection(update: Update, context: CallbackContext):
    text = update.message.text
...
# Пополнение баланса
def handle_payment_amount(update: Update, context: CallbackContext):
    try:
